...
public enum ErrorType {
    ...
    // 메세지 형식이 잘못된 경우(웹소켓)
    INVALID_MESSAGE_FORMAT(HttpStatus.BAD_REQUEST, "WEBSOCKET-001", "메세지 형식이 올바르지 않습니다."),

    // ==================================================================================================================

    LOGIN_USER_AND_SEND_USER_ARE_NOT_SAME(HttpStatus.BAD_REQUEST, "MESSAGE-01", "로그인한 유저와 메세지를 보내는 유저가 일치하지 않습니다.");
